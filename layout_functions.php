	...
	if (!isset($_SESSION['sessionID'])) {
		...
		<li class='topmenu'><a href='#' style='width:118px;height:15px;line-height:15px;'><span>Executive</span></a>
			<ul>	
				...
				<li><a href='http://localhost/service_admin.php' title='Regular Service Manager'>Service Manager</a></li>
...
<ul id="css3menu1" class="topmenu">
	...
	<ul>
		...
		<li><a href="http://localhost/service_dashboard.php" title="Service Dashboard">My Service</a></li>
		<li><a href="http://localhost/service_leader_dashboard.php" title="Project Leader Dashboard">My Projects</a></li>
