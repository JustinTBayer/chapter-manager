...
if (!isset($_SESSION['sessionID'])) {
	...
	echo '<div class="entry">You need to <a href="http://localhost/login.php">login</a> before you can use this page.</div>';
	...
	if (isset($_POST['update'])) {
		...
		if($result && $_POST[race] != "" && $_POST[gender] != 0){
			echo "Your information has been updated.  Click <a href='http://localhost/members_updateinfo.php'>here</a> to make more changes.";
			$_SESSION[active_sem] = $current_semester;
			echo $_SESSION[active_sem];

		} else {
			echo "There may have been an error.  Click <a href='http://localhost/members_updateinfo.php'>here</a> to try again.";
			$_SESSION[active_sem] = $current_semester;
			echo $_SESSION[active_sem];
		}
	} else {
...
<p>If you wish to change your password, please go <a href="http://localhost/members_updatepw.php">here</a>.</p>
