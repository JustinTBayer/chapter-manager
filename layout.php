...
$previous_semester = "Fall 2013";
$current_semester = "Spring 2014";
$next_semester = "Fall 2014";
	...
	if (!isset($_SESSION['sessionID'])) {
		...
		<li class='topmenu'><a href='#' style='width:118px;height:15px;line-height:15px;'><span>Executive</span></a>
			<ul>	
				...
				<!--<li><a href='http://localhost/service_admin_week.php' title='Regular Service Manager'>Service Manager</a></li>-->
				...
				<li><a href='http://localhost/brotherhood.php' title='Brotherhood'>Brotherhood</a></li>					
			</ul>
		</li>
		<li class='toplast'><a href='http://localhost/logout.php'style='width:119px;height:15px;line-height:15px;'>Logout</a></li>";
		...
		$login_logout_links = "<li class='toplast'><a href='http://localhost/logout.php'style='width:260px;height:15px;line-height:15px;'>Logout</a></li>";
	}
	$bother = "";
...
<head>
	...
	<link rel="stylesheet" href="http://localhost/includes/css/style.css" type="text/css" />
...
<div id="banner">
<img src="http://localhost/includes/css/css_images/header.png"/>
</div>
...
<ul id="css3menu1" class="topmenu">
	...
	<ul>
		...
		<li><a href="http://localhost/members_advisors.php" title="Advisors">Advisors</a></li>
	</ul>
	...
	<ul>
		...
		<ul>
			...
			<li><a href="http://localhost/officer_template.php?id=27" title="Appointed 1">Philanthropy</a></li>
			<li><a href="http://localhost/officer_template.php?id=31" title="Appointed 8">St. Baldrick's</a></li>
			<li><a href="http://localhost/officer_template.php?id=14" title="Communications">Communications Secretary</a></li>
			<li><a href="http://localhost/officer_template.php?id=32" title="Appointed 10">Homecoming</a></li>
			<li><a href="http://localhost/officer_template.php?id=33" title="Appointed 9">Advisor Liaison</a></li>
	...
	<ul>
		...
		<!--<li><a href="http://localhost/service_dashboard.php" title="Service Dashboard">Service Sign-Ups</a></li>-->
		<li><a href="http://localhost/attendance.php" title="Attendance">Attendance</a></li>
		<!--<li><a href="http://localhost/service_leader_dashboard.php" title="Project Leader Dashboard">Project Leader View</a></li>-->
